...
#' @param cluster_rows Hierarchically cluster rows based on eucledian distance. Default = T.
...
#' 
#' plot_cosine_heatmap(cos_matrix, col_order, cluster_rows = T, method = "complete")
#' 
#' 
#' @seealso
...
plot_cosine_heatmap = function(cos_sim_matrix, col_order, cluster_rows = T, method = "complete", plot_values = F)
{
