...
9 normal human adult stem cells from 3 tissues \cite{Blokzijl2016}.
...
package \cite{Gaujoux2010}. As described in their paper: ``...a common
...
Download signatures from pan-cancer study \cite{Alexandrov2013}
...
see the  \Biocpkg{biomaRt} documentation \cite{Durinck2005}.
