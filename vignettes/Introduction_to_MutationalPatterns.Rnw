...
<<plot_spectrum_4>>=
plot_spectrum(type_occurrences, by = tissue, CT = TRUE, legend = FALSE)
@
...
\begin{figure}[H]
\begin{center}
<<plot_96_profile, fig=TRUE, width=10, height=6>>=
...
\begin{figure}[H]
\begin{center}
<<estimate_rank, fig=TRUE, width=10, height=7>>=
...
\begin{figure}[H]
\begin{center}
<<plot_contribution, fig=TRUE,width=8,height=4>>=
...
\begin{figure}[H]
\begin{center}
<<plot_192_profile, fig=TRUE, width=12, height=4>>=
# combine plots
...
\begin{figure}[H]
\begin{center}
<<plot_enrichment_depletion, fig=TRUE, width=15, height=4>>=
