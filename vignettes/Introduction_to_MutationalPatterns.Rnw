...
head(type_context$types, 48)
head(type_context$context, 48)
@
...
\begin{figure}[H]
\begin{center}
<<combine_plot_spectrum, fig=TRUE, width=10, height=3>>=
library("gridExtra")
...
\begin{figure}[H]
\begin{center}
<<combine_plot_spectrum_2, fig=TRUE, width=10, height=3>>=
...
\begin{figure}[H]
\begin{center}
<<plot_96_profile, fig=TRUE, width=6, height=6>>=
...
\begin{figure}[H]
\begin{center}
<<plot_contribution_3, fig=TRUE, width=9, height=5>>=
...
\begin{figure}[H]
\begin{center}
<<plot_192_profile, fig=TRUE, width=10, height=5>>=
...
\begin{figure}[H]
\begin{center}
<<plot_rainfall, fig=TRUE, width=9, height=3>>=
