...
head(type_context$types, 50)
head(type_context$context, 50)
@
...
\begin{figure}[H]
\begin{center}
<<plot_contribution_2, fig=TRUE, height=2.5>>=
...
\begin{figure}[H]
\begin{center}
<<plot_contribution_3, fig=TRUE, width=9, height=3>>=
plot_contribution(nmf_res$contribution, nmf_res$signature, mode = "absolute",
                    index = c(1,2))
@
\end{center}
...
\begin{figure}[H]
\begin{center}
<<plot_contribution_4, fig=true, width=7, height=2>>=
plot_contribution(nmf_res$contribution, nmf_res$signature, mode = "absolute",
                    coord_flip = TRUE)
@
\end{center}
...
see the  \Biocpkg{biomaRt} documentation (Durinck et al. 2005).
